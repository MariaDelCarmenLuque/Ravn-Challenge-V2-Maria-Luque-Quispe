import { BadRequestException, Body, Controller, DefaultValuePipe, Delete, ForbiddenException, Get, HttpCode, HttpException, HttpStatus, NotFoundException, Param, ParseIntPipe, Patch, Post, Query, UnauthorizedException, UnprocessableEntityException} from '@nestjs/common';
import { ApiBadRequestResponse, ApiBearerAuth, ApiBody, ApiForbiddenResponse, ApiNotFoundResponse, ApiOperation, ApiQuery, ApiResponse, ApiTags, ApiUnauthorizedResponse, ApiUnprocessableEntityResponse } from '@nestjs/swagger';
            ...
            example: {
                "items": [
                    { 
                        ...
                        "imageUrl": "['https://site/subsite/documentlibrary/Desserts.jpg','https://site/subsite/documentlibrary/Desserts.jpg']",
                        "price": 230,
                        "stock": 15,
                        "status": "active",
                        "deletedAt": null,
